...
sqlClient1 = "INSERT INTO Client (username, nome, password, salt) VALUES ('u1', 'n1', '" + str(pass1) + "', '" + str(salt1) +"')"
...
sqlClient2 = "INSERT INTO Client (username, nome, password, salt) VALUES ('u2', 'n2', '" + str(pass2) + "', '" + str(salt2) + "')"
...
sqlClient3 = "INSERT INTO Client (username, nome, password, salt) VALUES ('u3', 'n3', '" + str(pass3) + "', '" + str(salt3) + "')"
mycursor.execute(sqlClient3)
client3ID = mycursor.lastrowid

#CLIENT4
salt4 = binascii.b2a_hex(os.urandom(8)).decode("utf-8")
pass4 = salt4 + hashlib.sha512((salt4 + "p4").encode("utf-8")).hexdigest()
sqlClient4 = "INSERT INTO Client (username, nome, password, salt) VALUES ('u4', 'n4', '" + str(pass4) + "', '" + str(salt4) + "')"
